...
coco_names = [x.strip() for x in open(coco_names_path, "r")]

udacity_names = ["biker", "car", "pedestrian", "trafficLight", "truck"]
crowdai_names = ["car", "pedestrian", "truck"]
bdd_names = [
    "bike",
    "bus",
    "car",
...
citypersons_names = ["fake", "pedestrian", "rider", "sitting", "unusual", "group"]
